...
$.each(a,(a,g)=>{h===g.gender&&j===g.ethnicity&&(b=g.name,c=g.pronounSubject,d=g.pronounObject,e=g.pronounPossAdj,f="/cctp623/photos/"+g.photo+".jpg")}),b?$("#story .text").load("/cctp623/stories/"+g+".html",()=>{// Change the selected words with the remixed text.

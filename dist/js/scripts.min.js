...
null!=h&&null!=j&&(a.preventDefault(),$.getJSON("/cctp623/data/people.json",a=>{// Loop through each person.
...
$("#story .name").html(b),$("#story .pronoun-subject").html(c),$("#story .pronoun-object").html(d),$("#story .pronoun-poss-adj").html(e),$("#story .photo").attr("src",f).attr("alt",b).show()}):($("#story .photo").hide(),$("#story .text").load("/cctp623/stories/none.html"))}))}),b.on("click",()=>{$("#story .photo").hide(),$("#story .text").html("")})});
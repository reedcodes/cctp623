...
const a=$("button.remix");// Find the submit button to remix the page.
// When the "remix" button is clicked or entered...
a.on("click",a=>{a.preventDefault();// Grab the user-selected attributes from the form.
let b=$("fieldset.gender input:checked").val(),c=$("fieldset.ethnicity input:checked").val(),d="";// Declare other variables we need.
// Grab the defined attributes from the JSON.
$.getJSON("../../data/people.json",a=>{// Loop through each person.
// Display the remixed text.
$.each(a,(a,e)=>{b===e.gender&&c===e.ethnicity&&(d=e.name)}),$("#name").html("Name: "+d),$("#gender").html("Gender: "+b),$("#ethnicity").html("Ethnicity: "+c)})})});
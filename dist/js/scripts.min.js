...
const a=$("button.remix"),b=$("button.restart");// Find the buttons to remix and restart the app.
// Declare the delay time.
let c=1e3;// When the "remix" button is clicked or entered...
...
null!=n&&null!=p&&null!=q&&(a.preventDefault(),setTimeout(()=>{// Grab the defined attributes from the JSON.
...
let a=o?o:n;// Load the correct story piece.
$("#story").fadeIn(c).delay(c),$("#story .text").load("/cctp623/stories/"+a+".html",()=>{$("#story ."+n).addClass("highlight"),$("#story .name."+n).html(b),$("#story .title."+n).html(d),$("#story .child."+n).html(e),$("#story .sibling."+n).html(f),$("#story .pronoun-subject."+n).html(g),$("#story .pronoun-object."+n).html(h),$("#story .pronoun-poss-adj."+n).html(j),$("#story .pronoun-being-present."+n).html(k),$("#story .pronoun-being-past."+n).html(l),$("#story .photo").attr("src",m).attr("alt",b).show()})}else// Display the "choose again" if there are no matches.
$("#story").fadeIn(c).delay(c),$("#story .photo").hide(),$("#story .text").load("/cctp623/stories/none.html")})},1250))}),b.on("click",()=>{$("#story").fadeOut(c),setTimeout(()=>{// Remove the attributes for the photo.

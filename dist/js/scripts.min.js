...
$("#story .name").html(b),$("#story .pronoun-subject").html(c),$("#story .pronoun-object").html(d),$("#story .pronoun-poss-adj").html(e),$("#story .photo").attr("src",f).show()}):($("#story .photo").hide(),$("#story .text").load("/cctp623/stories/none.html"))}))}),b.on("click",()=>{$("#none, #story").hide()})});
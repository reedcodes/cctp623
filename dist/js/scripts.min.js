...
a.on("click",a=>{a.preventDefault();// Grab the user-selected attributes from the form.
let b=$("fieldset.gender input:checked").val(),c=$("fieldset.ethnicity input:checked").val(),d="",e="";// Declare other variables we need.

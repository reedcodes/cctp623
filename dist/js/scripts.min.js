...
let d="",e="";// Grab the defined attributes from the JSON.
$.getJSON("../../data/people.json",a=>{// Loop through each person.
// Display the remixed text.
$.each(a,(a,f)=>{b===f.gender&&c===f.ethnicity&&(d=f.name,e="photos/"+f.photo+".jpg")}),$("#story").addClass("remixed"),$("#story .name").html(d),$("#story .photo").attr("src",e)})}}),b.on("click",()=>{$("#story").removeClass("remixed")})});